...
class DepartamentResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'System Management'; //secciona el menu de navegacion
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                //                                
                Forms\Components\TextInput::make('name' /*este es el nombre que le asignamos en la migracion*/)->required(),
            ]);
    }
